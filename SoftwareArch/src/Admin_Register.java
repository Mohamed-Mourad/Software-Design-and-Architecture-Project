...
public class Admin_Register  implements IRegister{
//	String username;
//	String email;
//	String phoneNumber;
//	String password;
//	
//	public Admin_Register(String U_Username,String U_PhoneNumber,String U_Password,String U_email) {
...
//	}
	...
	public void Register() throws IOException{
		 ...
		 try{
	          File file =new File(("E:\\Programs\\SoftwareArch\\Admin.txt"));
	          String str=null;
	    	  if(!file.exists()){
	    	 	file.createNewFile();
	    	  }
